...
[source,shell]
----------------------------------------------------------------------
go get github.com/cxfksword/beats
----------------------------------------------------------------------

In this guide, we use working examples from the Topbeat source code in https://github.com/cxfksword/beats[GitHub]
...
at the https://github.com/cxfksword/beats/blob/master/packetbeat/beat/packetbeat.go[Packetbeat]
code.
